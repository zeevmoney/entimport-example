...
func (cu *CarUpdate) SetEngineSize(i int32) *CarUpdate {
	cu.mutation.ResetEngineSize()
	cu.mutation.SetEngineSize(i)
	return cu
}

// AddEngineSize adds i to the "engine_size" field.
func (cu *CarUpdate) AddEngineSize(i int32) *CarUpdate {
	cu.mutation.AddEngineSize(i)
	return cu
}
...
func (cu *CarUpdate) SetNillableUserID(i *int) *CarUpdate {
	if i != nil {
		cu.SetUserID(*i)
	}
	return cu
...
func (cu *CarUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.EngineSize(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
	...
	if value, ok := cu.mutation.AddedEngineSize(); ok {
...
// SetEngineSize sets the "engine_size" field.
func (cuo *CarUpdateOne) SetEngineSize(i int32) *CarUpdateOne {
	cuo.mutation.ResetEngineSize()
	cuo.mutation.SetEngineSize(i)
	return cuo
}

// AddEngineSize adds i to the "engine_size" field.
func (cuo *CarUpdateOne) AddEngineSize(i int32) *CarUpdateOne {
	cuo.mutation.AddEngineSize(i)
	return cuo
}
...
// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (cuo *CarUpdateOne) SetNillableUserID(i *int) *CarUpdateOne {
	if i != nil {
		cuo.SetUserID(*i)
	}
	return cuo
...
func (cuo *CarUpdateOne) sqlSave(ctx context.Context) (_node *Car, err error) {
	...
	if value, ok := cuo.mutation.EngineSize(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt32,
			Value:  value,
			Column: car.FieldEngineSize,
	...
	if value, ok := cuo.mutation.AddedEngineSize(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt32,
			Value:  value,
			Column: car.FieldEngineSize,
