...
// EngineSize applies equality check predicate on the "engine_size" field. It's identical to EngineSizeEQ.
func EngineSize(v int32) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldEngineSize), v))
	})
}
...
// EngineSizeEQ applies the EQ predicate on the "engine_size" field.
func EngineSizeEQ(v int32) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldEngineSize), v))
	})
}

// EngineSizeNEQ applies the NEQ predicate on the "engine_size" field.
func EngineSizeNEQ(v int32) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldEngineSize), v))
	})
}

// EngineSizeIn applies the In predicate on the "engine_size" field.
func EngineSizeIn(vs ...int32) predicate.Car {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Car(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldEngineSize), v...))
	})
}

// EngineSizeNotIn applies the NotIn predicate on the "engine_size" field.
func EngineSizeNotIn(vs ...int32) predicate.Car {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Car(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldEngineSize), v...))
	})
}

// EngineSizeGT applies the GT predicate on the "engine_size" field.
func EngineSizeGT(v int32) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldEngineSize), v))
	})
}

// EngineSizeGTE applies the GTE predicate on the "engine_size" field.
func EngineSizeGTE(v int32) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldEngineSize), v))
	})
}

// EngineSizeLT applies the LT predicate on the "engine_size" field.
func EngineSizeLT(v int32) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldEngineSize), v))
	})
}

// EngineSizeLTE applies the LTE predicate on the "engine_size" field.
func EngineSizeLTE(v int32) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldEngineSize), v))
	})
}
